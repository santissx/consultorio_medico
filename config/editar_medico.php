...
if (isset($_POST["editar_med"])) {
    ...
    $sql_registro = "UPDATE registros SET nombres='$nombre', apellidos='$apellido' WHERE id_registro='$id_medico'";
    ...
    $sql_especialidad = "UPDATE especialidades SET nombre='$especialidad' WHERE id_especialidad='$id_especialidad'";
