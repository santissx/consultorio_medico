...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-05-2024 a las 00:08:22
...
(41, '03704206331', 'lea@gmail.com', 45, NULL),
(42, '03704788455', 'sdagasdf@gmail.com', 46, NULL);
...
INSERT INTO `medicamentos` (`id_medicamento`, `nombre`, `descripcion`, `ingrediente_activo`) VALUES
(1, 'frenaler', 'antialergico', 'desloratadina'),
(2, 'actron', 'para dolores musculares', 'ibuprofeno');
...
(45, 'masculino', '0000-00-00', 44, NULL),
(46, 'masculino', '0000-00-00', 45, NULL);
...
(8, '2024-05-29', 24, 2, 1),
(9, '2024-05-23', 24, 2, 1),
(10, '2024-05-18', 24, 2, 1),
(11, '2024-05-31', 24, 2, 2);
...
ALTER TABLE `medicosxespecialidades`
  ADD KEY `medicosxespecialidades_ibfk_1` (`id_medico`),
  ADD KEY `medicosxespecialidades_ibfk_2` (`id_especialidad`);
...
--
ALTER TABLE `documentaciones`
  MODIFY `id_documentacion` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `medicos`
  MODIFY `id_medico` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `personas`
  MODIFY `id_persona` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;

--
-- AUTO_INCREMENT de la tabla `prescripciones`
--
ALTER TABLE `prescripciones`
  MODIFY `id_prescripcion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `registros`
  MODIFY `id_registro` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
...
--
ALTER TABLE `medicosxespecialidades`
  ADD CONSTRAINT `medicosxespecialidades_ibfk_1` FOREIGN KEY (`id_medico`) REFERENCES `medicos` (`id_medico`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `medicosxespecialidades_ibfk_2` FOREIGN KEY (`id_especialidad`) REFERENCES `especialidades` (`id_especialidad`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `prescripciones`
  ADD CONSTRAINT `prescripciones_ibfk_1` FOREIGN KEY (`id_medico`) REFERENCES `medicos` (`id_medico`) ON DELETE CASCADE ON UPDATE CASCADE,
  ...
  ADD CONSTRAINT `prescripciones_ibfk_3` FOREIGN KEY (`id_medicamento`) REFERENCES `medicamentos` (`id_medicamento`) ON DELETE CASCADE ON UPDATE CASCADE;
